...
### ⚠ Para Lucía, lo urgente: mañana jueves 24/9 caen 89 promos visibles si nadie las relee desde casa
Son las que se verificaron el 13/9 con la lectura desde casa y que ninguna de las 41 fuentes de Actions nombra. Hoy salvé 40 de las 129 de ayer cruzándolas contra los comercios (ver abajo). Quedan **89**: **ICBC 55** (Coto lunes/martes/jueves/4.º finde, MasGO, La Anónima, YPF, farmacias, heladerías, pinturerías, ropa, cuotas…), **Comafi 18** (Makro, Axion, YPF, Shell, Puma, Farmacity, Cinemacenter, Aiello, cuotas…), **Frávega 8 cuotas por banco** (BBVA, Galicia, Santander, Patagonia, San Juan, Santa Fe, Santa Cruz, Ciudad 18 cuotas) más Corrientes viernes 10%, **Banco Santa Cruz 6**, **San Juan 2**. `node tools/recolectar.js icbc comafi fravega` desde casa hoy o mañana temprano las salva (Santa Cruz y San Juan no tienen receta: van con `WebFetch` desde tu compu, como el 13/9).

### El recolector: parcial de 12 fuentes, en 3 minutos
A las 07:36 ARG el cron de hoy no había arrancado (el último es el de ayer 09:41 ARG). Disparé una parcial con `vital yaguar ypf shell carrefour jumbo credicoop naranja-x patagonia macro cuenta-dni coto` a las 07:37: **commit `0c9cf1c` ("Texto de las fuentes al 2026-09-23 07:40")**, las 12 con `leido: 2026-09-23`. Ayer a las 09:53 había corrido el completo de las 41 (commit `bf5f50c`), así que ChangoMás, Disco, Vea, Diarco y Sodimac tienen texto del 22/9 y lo usé fechado al 22/9. Carrefour, Jumbo, Cuenta DNI y Patagonia dicen hoy exactamente lo mismo que ayer. Siguen viejas **ICBC, Comafi y Frávega (13/9, desde casa; Actions las intenta y vuelve con Cloudflare/403)**, Ciudad (10/9), McDonald's y Musimundo (27/8).

### ChangoMás (texto del 22/9, siete pestañas enteras): 18 confirmadas, 1 revivida, 3 altas, 2 corregidas
Cruzadas tarjeta por tarjeta contra el legal:
- **Confirmadas al 22/9, iguales:** Mercado Pago martes 15% sin tope (MP); BNA+ miércoles 35% $15.000/sem (N1); Columbia mar/sáb 20% $10.000 (BC, vence 30/9); QR billeteras vie/sáb/dom 15% sin tope (BV); MásClub MasGO mié/jue 20% (MC); ANSES 10% y empleados públicos 10% todos los días (A, EM); ICBC jueves 20% $10.000/sem (IC3); ICBC 4.º finde 20% $15.000 por finde, sábado 26 y domingo 27 (IC1); Comafi martes 20% $12.000/sem al 31/10 (CMF); Hipotecario martes 25% débito al 30/11 (H); YOY jueves 20% (Y); Credicoop jueves 30% Cabal $9.000/sem (C1); Supervielle jubilados martes 20% (S2); Patagonia sábados 15% Clásica/Plus $10.000 (P1) y Singular 30% (P3: la tarjeta dice $15.000, el legal dice 25% y $15.000; se mantiene lo que publica el banco, $20.000, como se decidió el 27/8).
- **Revivida `ciudad-mastercard-masgo-jueves-35`** (estaba en `baja` desde el 19/9 por los 10 días): la tarjeta (BC-MG) dice con todas las letras "Todos los jueves en MasGO 35% con tarjeta de crédito Mastercard a través de Buepp y App Ciudad, tope $20.000 mensual", y el legal es del Banco de la Ciudad de Buenos Aires, válido del 27/08 al 31/12/2026, presencial, QR MODO. Nivel 2 nombrando al emisor con los mismos números que tenía el catálogo del banco el 8/9: la revivo como pide el instructivo y le estiro la vigencia al 31/12 (la que dice el legal). **Para que lo mire un humano.**
- **Alta `modo-masgo-domingo-20`** (MODO-MG): domingos 20% de reintegro en MasGO desde MODO o app de banco adherido, mínimo $30.000, tope $20.000 por cliente por mes y por banco, del 16/08 al 31/10/2026, presencial, acumulable. Es la versión genérica de `supervielle-masgo-domingo` (que ya teníamos) y de `ciudad-masgo-20` (en `baja`, y sigue ahí: la tarjeta no nombra a Ciudad).
- **Alta `modo-changomas-martes-29-20`** (MD-29): **solo el martes 29 de septiembre**, 20% de reintegro con MODO o app de banco adherido, crédito o débito (no transferencia), presencial y Más Online, mínimo $75.000, tope $25.000 por banco. Vale un solo día y tiene una sola fuente (nivel 2, con el legal de Play Digital completo): si Supervielle o Credicoop la nombran antes del 29, sumarlos.
- **Alta `credicoop-changomas-sabado-26-30`** (C2 + Credicoop): **solo el sábado 26 de septiembre**, 30% con Cabal Credicoop por QR MODO desde Credicoop Móvil, tope $13.500 por persona. Es un 30% de un solo día, cruzado: ChangoMás publica el legal (sábados 25/7, 29/8 y 26/9) y Credicoop la lista hoy y ayer como "Supermercados | 30% de ahorro | sábado" (slug `Grupo-ChangoMas_Sabado-MODO`).
- **Corregida `patagonia-changomas-miercoles` → Banco del Chubut.** La tarjeta dice "Con tarjeta de Crédito Patagonia 365" y la teníamos como Banco Patagonia, pero el legal dice **"BANCO DEL CHUBUT S.A. CUIT 30-50001299-0, Rivadavia 615, Rawson"**: Patagonia 365 es el programa del Banco del Chubut. Pasa a `medio: chubut` (el mismo de `chubut-diarco-mayorista-jueves-20`), conservo el id para no romper favoritos. **Para que lo mire un humano**; si prefiere el id nuevo, se renombra.
- **Corregida `icbc-changomas-4to-finde-sep-20`**: `tope_periodo` pasa de `sin_aclarar` a `por fin de semana` (el legal: "$15.000 por cliente por fin de semana").
- **No cargadas:** Bancor 4 cuotas todos los días (4CB, no tenemos ese medio); Tarjeta SOL jueves 4 cuotas + reintegro (la tarjeta dice 20%, el legal 30%: se contradice a sí misma, y es de Santiago/NOA); "Jueves a domingos 3 cuotas" (G4) sin banco en el legal; Tuya 4 y 5/9 (pasó). `modo-changomas-lunes` no aparece en la pestaña del lunes del 22/9 (solo la del martes 29): no la toco por ausencia, ChangoMás rota tarjetas; queda verificada al 18/9 por MODO.

### Carrefour (texto de hoy, idéntico al de ayer): 19 confirmadas al 23/9
Las 14 que ayer cumplían 10 días (Carrefour Banco martes 20%, jueves 20% online, viernes 15% y finde 10% con Cuenta Digital, 3 cuotas finde; Mercado Pago Maxi viernes 10%, jueves 15% dinero en cuenta, crédito lunes 15%, 6 cuotas sin tarjeta; ANSES/mayores 10% tope $35.000; online jueves 10% $8.000/sem; empleados públicos miércoles y jueves 15% por provincia; Club La Nación lunes 15%) más Patagonia miércoles 15/20/30% plan sueldo, BNA jubilados 5% y las de Cuenta DNI miércoles. Todo igual, vigencias al 30/9.

### Cencosud (Jumbo hoy; Disco y Vea del 22/9): 9 confirmadas
Hipotecario martes 25% débito $15.000/mes (Jumbo y Disco); Naranja X Plan Z 3 cuotas; Cencopay Cuenta lunes 25% $15.000; MODO Jumbo mar/jue 20% desde $100.000 y Disco vie/sáb; Macro 3 cuotas online jue-dom; Cencopay miércoles online 20% + 3 cuotas; Cencopay Vea jueves 25% galletitas; 40% galletitas/cervezas vie/sáb tope $15.000 por día. Los tres sitios traen el domingo vacío ("no está la pestaña"), como siempre.

### Credicoop (hoy, página del miércoles), Macro, Naranja X, Sodimac, Cuenta DNI, Coto
- **Credicoop** confirma (nivel 1) Diarco Barrio 20% y Diarco Pueblo/Mayorista 15% los sábados y domingos, y Frávega 12 cuotas Cabal. **Alta `credicoop-carrefour-miercoles-10`**: hoy aparece "Supermercados | 10% de ahorro" con slug `Carrefour_CABAL-VISA-MODO-LOCALES-ADHERIDOS`, miércoles; el listado no publica tope ni vigencia (`tope_publicado: false`, vigencia al 30/9 como el resto). También lista hoy las 12 cadenas del interior de los miércoles y las tarjetas de cuotas (Rosen, Petrios, Cannon…) que no cargamos.
- **Macro** (API, 2.298 registros): Frávega 2 a 12 cuotas sigue; lo nuevo de hoy son comercios de provincia (Misiones, Santa Fe, Tucumán, Jujuy, Santa Cruz) con cuotas.
- **Naranja X** confirma Andesmar 10% + 6 cuotas y Frávega 12 cuotas (esta última no está cargada como promo de Naranja; queda para otro día).
- **Sodimac** (22/9): "Banco ICBC 6 cuotas sin interés hasta el 30/09/2026" confirma `cuotas-icbc-sodimac-6`.
- **Cuenta DNI** (hoy, catálogo idéntico al 22/9): las 27 de ayer pasan a verificadas al 23/9. Toledo 15% sin tope sábado 26 y domingo 27 sigue sin aparecer.
- **Coto** (hoy, página del miércoles): mismas tarjetas que ayer, reordenadas por día; las 14 de ayer pasan al 23/9. Aparecen dos tarjetas nuevas sin banco en el texto ("25% jueves" y "20% viernes utilizando todos los medios de pago dentro de la app"): no se cargan.

### La Gallega (Banco Santa Fe) a `baja`
`santa_fe-supermercados-la-gallega-viernes` (30% viernes, vigencia publicada al 31/12) cumplió hoy 11 días sin verificar: Banco Santa Fe no está entre las 41 fuentes y Credicoop, que la nombraba como "LA GALLEGA 30%" hasta el 21/9, no la lista desde el 22/9. Va a `baja` con motivo; se revive con una lectura de bancosantafe.com.ar.

### Agenda: qué se trabajó
Pidió 6 (fravega, comafi, vital, yaguar, ypf, shell). Se miraron las 6; **ninguna aportó desde su propio texto**:
- **Frávega** y **Comafi** ➖ Actions vuelve con CloudFront 403 y "Verificación de seguridad" de Cloudflare (hoy y ayer). Lo que se pudo hacer fue confirmarlas de costado: Frávega 12 cuotas por Credicoop, Macro y Naranja X (nivel 1); Comafi martes 20% en ChangoMás por el legal de ChangoMás. Las otras 18 de Comafi y 8 de Frávega caen mañana.
- **Vital** ❌ (nunca aportó): `vital.com.ar/promociones` trae el esqueleto ("Por día / Por medio de pago / Lunes…Domingo") y ninguna promo: las tarjetas se cargan por JavaScript después de elegir sucursal. Habría que darle sucursal en la receta.
- **Yaguar** ❌ (nunca aportó): Cloudflare bloquea al runner ("Sorry, you have been blocked"), hoy y ayer.
- **YPF** ❌ (nunca aportó): `ypf.com/promociones` responde "Lo sentimos, esta página no está disponible en este momento". La URL de la ficha está muerta; las de YPF las tenemos por ICBC, Comafi y Cuenta DNI.
- **Shell** ❌ (la más abandonada, 14 días): sigue siendo la landing del sorteo "Las Vegas" (21/9 al 18/10), sin un solo beneficio.

### Para Lucía
1. **Correr desde casa `node tools/recolectar.js icbc comafi fravega` antes de mañana 24/9**: 89 promos visibles (55 ICBC, 18 Comafi, 8 cuotas de Frávega por banco) pasan a `baja` por los 10 días si no. Santa Cruz (6) y San Juan (2) van con `WebFetch` desde tu compu.
2. **Ciudad Mastercard jueves 35% en MasGO revivida** porque ChangoMás publica el legal del Banco Ciudad con los mismos números; las otras 48 de Ciudad siguen en `baja` (13 días sin leer la API).
3. **"Patagonia 365" es del Banco del Chubut**: `patagonia-changomas-miercoles` cambió de medio (mismo id). Si querés, se renombra a `chubut-changomas-miercoles-20`.
4. **Martes 29/9: MODO 20% en ChangoMás** (mínimo $75.000, tope $25.000 por banco) cargada con una sola fuente; y **sábado 26/9: Credicoop 30% Cabal en ChangoMás** cargada con dos.
5. **La Gallega (Santa Fe) a `baja`** por los 10 días: una lectura de bancosantafe.com.ar la revive.
6. Vital necesita sucursal en la receta; YPF y Farmacity tienen la URL muerta; Yaguar y Comafi/Frávega bloquean al runner; Shell cambió de página. Con BNA, La Anónima, Maxiconsumo y Axion, la agenda rota nueve "nuevas" que no pueden aportar.

## 2026-09-22 — La parcial de Actions trajo las 10 fuentes pedidas con texto de hoy en 2 minutos; Cuenta DNI (25), Personal Pay (7), Galicia (6), Ualá (1) y Coto (13) confirmadas al 22/9; alta de Supercoop 15% vie/sáb con Cuenta DNI; Nini retirada porque el catálogo de Cuenta DNI la sacó; Galicia combustible estirada al sábado 10/10; BNA nombra a Coto martes 20% y suma como nivel 1 a la campaña MODO. Agenda: 6 pedidas, 6 miradas, ninguna aportó desde su propio texto. ⚠ El 24/9 cumplen 11 días 129 visibles (58 de ICBC, 19 de Comafi): hace falta una lectura desde casa antes

**597 promos (eran 596): 1 alta (Supercoop), 0 revividas, 1 retirada (Nini, vigencia al 15/9), 1 estirada (Galicia combustible al 10/10), 2 corregidas en la letra chica (Cooperativa Obrera suma La Plata, La Anónima suma el mínimo de $25.000), 54 verificadas al 22/9.** Push: ver abajo. **Visibles hoy: 390 con vigencia al 22/9 (eran 389)**, 205 valen un martes, 195 un miércoles. Ninguna visible lleva más de 10 días sin verificar; las 49 que sigue listando `validar` son todas invisibles (vencidas al 31/8 o en `baja`).

### ⚠ Para Lucía, lo urgente: el jueves 24/9 caen 129 promos visibles si nadie las relee
Todas las que se verificaron el 13/9 cumplen 11 días el 24/9 y la regla las manda a `baja`. Son **129 visibles**: ICBC 58, Comafi 19, "cualquier medio" 9, Santa Cruz 6, Mercado Pago 5, Carrefour Banco 5, cencopay 4, Credicoop 4, Naranja X 2, Patagonia 2, MODO 2, Macro 2, San Juan 2 y una de cada uno de BNA+, Hipotecario, Ciudad, Columbia, BBVA, Galicia, Santander, Santa Fe y Corrientes (las 12 cuotas de Frávega por banco, entre otras). ICBC, Comafi y Frávega **no se leen desde Actions** (403/Cloudflare): la única salida es correr `node tools/recolectar.js icbc comafi fravega` desde casa el martes o el miércoles. Lo que sí se lee desde Actions (Mercado Pago vía Carrefour/Jumbo, Credicoop, Naranja X, Macro, Patagonia, Santa Cruz…) lo cruzo mañana con una parcial. Además mañana cumple 11 días `santa_fe-supermercados-la-gallega-viernes` (Banco Santa Fe no está entre las 41 fuentes; Credicoop la nombraba ayer como "LA GALLEGA 30%" pero hoy no).

### El recolector: parcial de 10 fuentes, en 2 minutos
A las 07:32 ARG el cron de hoy no había arrancado (el de ayer a las 11:21 ARG se canceló a los 15 minutos, como todos los días desde el 18). Disparé una parcial con `axion bna farmacity shell cuenta-dni personal-pay galicia uala coto credicoop` a las 07:33: **terminó en 2 minutos, commit `27ae5d2` ("Texto de las fuentes al 2026-09-22 07:34")**, las 10 con `leido: 2026-09-22`. No disparé el completo. Galicia, Personal Pay, Ualá y Axion dicen exactamente lo mismo que el 19/9 (solo cambió la línea `leido:`). Siguen viejas **ICBC, Comafi y Frávega (13/9, desde casa), Ciudad (10/9), McDonald's y Musimundo (27/8)**, y las 30 restantes al 19/9 o 20/9.

### Cuenta DNI (texto de hoy, idéntico al 19/9 salvo dos "especiales" que se fueron): 25 confirmadas, 1 alta, 1 retirada, 2 corregidas
Cruzadas una por una contra el legal de cada bloque (día, %, tope, período, vigencia, medio de pago):
- **Confirmadas al 22/9, iguales (25):** cercanía 20% lun-vie $6.000/sem; garrafas 40% $18.000/mes; gastronomía 25% sáb/dom $8.000/sem; ferias 40% $6.000/sem; universidades 40% (el sitio sigue diciendo $6.000/sem, se mantiene el $4.000 cargado como se decidió el 29/8); súper del interior 15% mar/mié $6.000/sem mínimo $30.000; Día lunes 10% y 20% NFC; librerías 10% lun/mar al 29/12; Toledo martes 15% y 20% NFC; marcas destacadas 30% $15.000/mes; YPF Full 25% sáb/dom $8.000/sem; farmacias 10% mié/jue al 31/12; Sodimac 10% mié; La Anónima 10% mié $5.000; Josimar 10% mié al 31/10; 3 cuotas al 31/10; Carrefour 10% mié mínimo $15.000; ChangoMás 20% jue; Mostaza 25% y 30% NFC jue/vie al 11/12; pet shops 30% sáb $8.000; Cooperativa Obrera 15% vie/sáb; Coto 30% NFC jueves (su último jueves es el 24/9: se apaga sola el 25).
- **Alta `cuenta-dni-supercoop-vie-sab-15`**: bloque nuevo `supercoop-1058` (apareció el 19/9, hoy sigue igual): 15% viernes y sábados del 18/9 al 31/10, pagando con Clave DNI, "únicamente en los comercios adheridos bajo el nombre SUPERCOOP", sin tope, descuento en el ticket, excluye hogar, carnes y pescados. **Zona: Provincia de Buenos Aires**, que es la zona de todas las de Cuenta DNI; el legal no nombra localidades. Para que lo mire un humano: Supercoop es la cadena cooperativa del sudoeste bonaerense (Coronel Pringles y alrededores); si no es así, corregir la zona.
- **Retirada `cuenta-dni-nini`** (vigencia al 15/9, `baja_motivo`): el catálogo de Cuenta DNI (API, todos los bloques) la listó hasta el 15/9 y **no la lista más desde el 16/9: cinco lecturas seguidas (16, 17, 18, 19 y 22/9) con la página entera cargada**. El legal del 12/9 nombraba "martes 1, 8, 15 y 29 de septiembre", así que puede que el banco la vuelva a publicar cerca del 29: si aparece, se revive con ese bloque.
- **Corregidas:** `cuenta-dni-cooperativa-obrera-lobos` decía "solo Lobos" y el legal de hoy dice **"localidades de Lobos y La Plata"** (y solo con Clave DNI, no QR); `cuenta-dni-la-anonima` no decía que aplica **a partir de un ticket de $25.000**.
- **No cargadas:** las dos "especiales" que estaban el 19/9 y hoy no están: Día del Estudiante 30% (fue el 21/9, solo 13 a 17 años) y **Toledo 15% sin tope los sábados 19 y 26 y domingos 20 y 27/9** (el banco la sacó del listado hoy, con el 26/27 todavía por venir: no la cargo por ausencia, pero si el jueves reaparece vale para este finde). `especiallocalidades-532` ("Lunes a jueves 15%, hasta abril") viene con el legal cortado en "PROMOCIÓN VÁLIDA DEL": sin datos.

### Personal Pay (7), Galicia (6) y Ualá (1): todas iguales, confirmadas al 22/9
Los tres listados son idénticos al 19/9. Personal Pay: Día 15% jue, La Reina 10% sáb, Farmacia Central Oeste 20% mié, Farmalife 10%, Puma 10% sáb, Taxi Premium 30% lun-mié, Go Bar 15%. Galicia (portada): Jumbo 20% mar/jue, Starbucks 25%, Mimo 25% vie + 3 cuotas, CCKonex 20% + 3 cuotas, Bridgestone 12 cuotas, Rex 6 cuotas. Ualá: colectivos 50% Contactless. Ninguno de los tres listados muestra tope ni vigencia: lo que confirman es día, comercio y porcentaje.

**`galicia-combustible-dia10` estirada al sábado 10/10**: la portada de Galicia dice con todas las letras "Hasta 15% de ahorro en combustible. **Los días 10 de cada mes**, en YPF, Puma, Shell y Axion, pagando con MODO desde la App Galicia, con tu tarjeta Mastercard". Estaba vencida al 10/9. Queda `dias: [sabado]`, vigencia 10/10 al 10/10, con el tope $15.000 mensual que publicó el legal del banco para septiembre (Galicia no lo repite en la portada; si alguien lee el legal de octubre, confirmarlo).

### Coto y Credicoop (texto de hoy): sin cambios, 13 confirmadas
Coto publica hoy exactamente las mismas tarjetas que ayer; solo se fueron las dos de Credicoop del 19-21/9, que vencieron solas (siguen en el JSON con vigencia al 21/9). Confirmadas al 22/9 las 13 que ayer se cruzaron contra Coto (Comunidad, ciudadanía porteña, jubilados jueves, Naranja X Épico/Turbo/Inicial, Supervielle 25%, Comafi 30%, Credicoop lunes 30% (también en Credicoop hoy, slug `Coto_MODO-lunes`), MODO NFC jueves 30%, TCI martes, Mercado Pago 3 cuotas, Ciudad lunes 25%, MODO martes 20%). Credicoop hoy es la página del martes: ya no muestra las 12 cadenas del interior del miércoles ni las tarjetas de cuotas (Rosen, Petrios, Cannon…); ninguna estaba cargada. Siguen sin banco en el texto las 7 tarjetas de Coto con el banco en imagen (10% lun-jue, 15% viernes crédito, 30% jueves Visa "Segmento Único", 30%/25%/20% lunes, 20% jueves Visa).

### Agenda: qué se trabajó
Pidió 6 (fravega, comafi, axion, bna, farmacity, shell). Se miraron las 6; **ninguna aportó desde su propio texto**:
- **Frávega** y **Comafi** ➖ la agenda pide "trabajarlas enteras" pero la única lectura buena sigue siendo la del 13/9 desde casa, que ya se cruzó entera el 14/9 (las 19 de Comafi y las 12 cuotas de Frávega por banco tienen `verificado: 2026-09-13`). Releer el mismo texto no las confirma con fecha nueva: **caen el 24/9 si no hay lectura desde casa** (ver arriba).
- **Axion** ❌ (nunca aportó): `axionenergy.com/promociones` de hoy es idéntica al 19/9: títulos de bases y condiciones ("Descuento Super", "Desafío Redondo", Lollapalooza 2025, pelota Copa Argentina) sin ningún banco, día ni porcentaje. No hay promo bancaria en esa página; las de Axion las tenemos por Brubank y Comafi.
- **BNA** ❌ (nunca aportó): el listado de `bna.com.ar` sigue siendo pobre: nombre, % y fechas, sin día ni tope ni tarjeta ("Consultar condiciones, tarjetas participantes, vigencia y topes haciendo clic en cada promoción"). Lo único que cambió hoy es "Shopping con BNA 20% y hasta 9 cuotas", que pasó del 16-17/9 al **23-24/9** (sin comercios ni tope: no se carga). **Sí sirvió como cruce**: "COTO | 20% de descuento los días martes | del 18-8 al 31-10-2026" confirma la campaña MODO de Coto y la sumé como nivel 1 a `modo-coto-martes-20` (ya son 5 fuentes). "Tucson 25% todos los días (1-9 al 30-9)", "YPF 20% (1-3 al 30-9)" y "KFC 20% (1-6 al 30-9)" siguen sin tarjeta ni tope: no se cargan. Para Lucía: la receta tendría que abrir cada promo (el "clic en cada promoción").
- **Farmacity** ❌ (nunca aportó): `farmacity.com/promociones-bancarias` es un 404 del sitio ("No encontramos resultados para promociones-bancarias"), hoy igual que siempre. **La URL de la ficha está muerta**; las de Farmacity las tenemos por Comafi.
- **Shell** ❌ (la más abandonada, 13 días): `promoshellbox.shell.com.ar` hoy no es la lista de beneficios sino **la landing de la promo "Las Vegas" (sorteo del 21/9 al 18/10)**: la lectura vino entera (2,7 KB) pero sin un solo beneficio. Del 10/9 al 19/9 venía vacía. La lista de beneficios de Shell Box quedó en otra ruta; la última buena es la del 9/9, y además ahí los bancos están en imagen. La única promo que dependía de Shell (`galicia-combustible-dia10`) se confirmó hoy por Galicia.

### Para Lucía
1. **Correr desde casa `node tools/recolectar.js icbc comafi fravega` antes del jueves 24/9**: si no, 129 promos visibles (58 de ICBC, 19 de Comafi, las 12 cuotas de Frávega) pasan a `baja` por los 10 días.
2. **Supercoop 15% con Cuenta DNI** quedó con zona Provincia de Buenos Aires: chequear que la cadena sea la del sudoeste bonaerense.
3. **Nini se retiró** porque el catálogo de Cuenta DNI la sacó desde el 16/9, aunque el legal del 12/9 nombraba el martes 29/9. Si la ves en la app de Cuenta DNI, se revive.
4. **Toledo 15% sin tope sábado 26 y domingo 27/9 con Cuenta DNI** existió en el listado hasta el 19/9 y hoy no está: no la cargué. Si reaparece el jueves, cargarla para el finde.
5. **Shell Box cambió de página** (landing del sorteo): habrá que buscar la ruta nueva de los beneficios. **Farmacity** sigue 404 y **Axion** no publica promos bancarias: con BNA, La Anónima, Maxiconsumo, Vital, Yaguar e YPF ya son nueve "nuevas" que la agenda rota sin que puedan aportar.
6. **BNA**: la receta tendría que abrir cada promo del listado; hoy nombra Coto martes (ya cargada), Tucson 25% todos los días, YPF 20% y KFC 20% sin condiciones.
7. Banco Ciudad sigue sin leerse desde Actions (12 días, desde el 10/9): las 48 en `baja` esperan la lectura desde casa.

## 2026-09-21 — Coto de hoy revive Banco Ciudad lunes 25% (Coto nombra al banco) y las 3 cuotas de Mercado Pago, y confirma 11 más; alta de la campaña MODO martes 20% sin tope en Coto (Coto + Comafi + Credicoop + Ciudad); TCI pasa de lunes a martes y solo Coto Digital; 2 de Macro a `baja` (PedidosYa Plus 35% por contradicción del propio banco, Movilidad sábados 30% porque la API no la trae); las 10 visibles que hoy cumplían 11 días quedaron 8 confirmadas y 2 en baja; las 57 de Brubank cruzadas enteras contra brubank.com del 20/9 (todas iguales) para que mañana no caigan. Ciudad vacía por 11.º día. Agenda: 7 pedidas, 7 miradas, ninguna aportó desde su texto

**596 promos (eran 595): 1 alta, 2 revividas, 0 retiradas, 2 a `baja` (Macro, no vencidas), 1 corregida (TCI), 15 verificadas al 21/9 (Coto), 57 al 20/9 (Brubank) y 8 al 19/9 o 18/9 (Día, Carrefour, Cencosud, Naranja X, Macro).** Push: ver abajo. **Visibles hoy: 391 con vigencia al 21/9 (eran 390)**, 196 valen un lunes, 206 un martes. Ninguna visible queda con más de 10 días sin verificar; las 50 que sigue listando `validar` son todas invisibles (vencidas al 31/8 o en `baja`). **Mañana cumplen 11 días 39 visibles (24 de Cuenta DNI, 7 de Personal Pay, 6 de Galicia, Ualá colectivos y La Gallega de Santa Fe): cuenta-dni, personal-pay y galicia tienen texto del 19/9 en `crudo/`, así que se cruzan mañana temprano.**

### ⚠ Para que lo mire un humano: Banco Ciudad en Coto los lunes vuelve a la app
`ciudad-coto-lunes-25` estaba en `baja` desde el 19/9 por la regla de los 10 días (la API de Ciudad no se lee desde el 11/9). **La página de Coto de hoy (sucursales, lunes) dice con todas las letras: "25% pagando con MODO desde la app de Ciudad con tarjetas de crédito del banco, tope de reintegro $30.000 por transacción".** Es nivel 2 nombrando al emisor con los mismos números: la revivo, como pide el instructivo. Única diferencia: Coto dice "por transacción" y el catálogo del banco (10/9) "por semana"; queda **por semana**, que es lo que dice el emisor y lo más chico. Las otras 48 de Ciudad/Buepp siguen en `baja`: ninguna otra página de comercio nombra al banco (Coto martes 20% dice "app de tu banco o app MODO", sin nombrar a Ciudad; ver la alta de abajo).

### Alta: MODO martes 20% sin tope en Coto (la campaña que todos los bancos "suman")
`modo-coto-martes-20` (medio MODO, martes, 20%, sin tope, sucursales, hasta el 31/10). No la teníamos suelta, solo las versiones por banco (Comafi 30%, Supervielle 25%, Ciudad 20% en baja). La sostienen cuatro fuentes: **Coto hoy** ("20% pagando con QR desde la app de tu banco o app MODO, sin tope, presencial en un pago, productos sin oferta"), **Comafi 13/9** (nivel 1: "Coto | 20% | MODO | Los Martes", con el legal de Play Digital: martes del 01/09 al 31/10/2026, QR MODO, no online; Comafi suma 10% "al 20% de la campaña modo.com.ar/promos/coto-agos26"), **Credicoop hoy** (tarjeta "Supermercados | 20% de ahorro", slug `COTO_20%-ahorro-martes-MODO-CABAL-VISA`) y **Ciudad 10/9** ("Coto | martes | 20% | SIN TOPE"). Es un "sin tope" con cruce de sobra. Los `requisitos` aclaran que es con los bancos adheridos a MODO y nombran los extras de Comafi y Supervielle.

### Coto (texto de hoy 07:34): 11 confirmadas, 1 revivida más, 1 corregida
- **Confirmadas al 21/9, iguales:** `coto-comunidad-15` (mié 15% Comunidad Coto, sin límite), `coto-ciudadania-portena-15` (mar/jue 15%), `coto-jubilados-jueves-15` (jue 15% con DNI), `coto-naranja_x-martes-30` (Plan Épico, $12.000/semana), `naranja-super-martes` (Plan Turbo 25% $9.500/semana; Inicial 20% $3.000), `coto-supervielle-martes-25` (MODO app Supervielle, sin tope), `comafi-coto-martes-30` (MODO app Comafi, sin tope), `coto-credicoop-lunes-30` (lunes 7, 14 y 28/9, $15.000/semana, Digital y sucursales), `credicoop-coto-19-21-sept-40-plan-sueldo` y `credicoop-coto-digital-19-21-sept-30` (hoy es su último día, siguen publicadas; Credicoop también la lista hoy), `coto-modo-nfc-jueves-30` ("30 OFF PROMO VISA DÉBITO" NFC jueves sin tope).
- **Revivida `cuotas-mp-coto-3`** (Mercado Pago, 3 cuotas desde $150.000 y 2 cuotas de $50.000 a $149.000, pagando con QR con la tarjeta de crédito de Mercado Pago, solo sucursales): estaba en `baja` con vigencia al 31/8 y Coto la publica hoy tal cual, todos los días. Coto no dice hasta cuándo: vigencia al 30/9 asumiendo el mes, como con Diarco.
- **Corregida `coto-tci-martes-20`**: decía lunes. Coto publica la tarjeta TCI 20% sin tope **solo en Coto Digital y los martes**; la de sucursales de los lunes se publicó hasta el 16/9 y desde el 17/9 no está (cinco lecturas seguidas). Pasa a martes, solo tienda online.
- **No revividas aunque Coto tiene una tarjeta parecida**: `coto-anses-lun-jue-10` (Coto publica "10% lun a jue, débito y crédito, sin tope, sucursales" pero el banco o programa está en la imagen, el texto no dice ANSES ni nada) y `coto-cualquiera-viernes-15` ("15% TARJETAS DE CRÉDITO viernes sin tope", ídem: no dice de qué banco). Para Lucía: si la receta saca el `alt` o el nombre de la imagen de esas dos tarjetas, salen solas. Lo mismo para "30% jueves Visa y Mastercard crédito sin tope" (¿Brubank Ultra? ¿Columbia?), "30% plan sueldo lunes Visa/MC tope $20.000", "25% lunes Visa/MC/Cabal tope $30.000", "20% lunes Visa/MC/Visa débito tope $15.000" (¿ICBC?) y "20% jueves Visa tope $25.000" (¿Patagonia?): números que coinciden con promos que tenemos pero sin el banco en el texto no confirman nada.

### Las 10 visibles que hoy cumplían 11 días (todas verificadas por última vez el 10/9)
Cruzadas contra el texto del 19/9 (el último del cron entero), fechadas al 19/9 (o 18/9), no al 21:
- **Confirmadas iguales (8):** `bna-dia-lun-vie` (Día: legal "Modo, BNA" lunes a viernes al 30/09, $5.000/semana y $20.000/mes, solo jubilados ANSES en BNA), `bna-jubilados-extra` (Carrefour: 5% jubilados BNA lunes a viernes al 30/09; ChangoMás no lo publica), `naranja-chevallier-10` (Naranja X del 18/9: el listado rota y el 19/9 no la mostró; 10% + 6 cuotas), `macro-mcdonalds-nfc-20` (API de Macro, bloque de todo el país: "MC DONALDS GOOGLE PAY APPLE PAY MODO NFC | 20% | todos los días | General"), `cuotas-naranja_x-suavegom-14` (Naranja X: 14 cuotas), `cuotas-bna-jumbo-disco-vea-6` (las tres páginas de Cencosud: 6 cuotas electro con Visa/MC Banco Nación), `cuotas-comafi-jumbo-disco-vea-3` (todos los días al 30/09/26) y `cuotas-comafi-jumbo-disco-vea-electro-12` (vie/sáb/dom del 01/09 al 30/09/26).
- **A `baja` (2, de Macro, no vencidas):**
  - `macro-pedidosya-plus-35`: **el propio banco se contradice.** La portada del 10/9 decía "hasta 35% en PedidosYa Plus, lunes, martes y viernes, solo usuarios Plus"; la API del catálogo (19/9) dice "PEDIDOS YA | 35% | martes | General | débito" y la ubica en Buenos Aires. Mismo nivel, sin forma de desempatar un 35%: no se muestra. Se revive abriendo la promo en macro.com.ar y viendo día, tarjeta y tope.
  - `macro-movilidad-sabado-30`: salió de la portada ("Movete por la ciudad, sábados 30%"); desde el 16/9 la receta lee la API (2.200 registros, todas las provincias) y ahí no hay nada de movilidad/transporte los sábados, y la portada no se lee más. No sé si venció: queda en baja hasta que alguien la vea.

### Brubank: las 57 cruzadas contra brubank.com del 20/9, todas iguales
Mañana cumplían 11 días. Escribí un cruce por script (plan + comercio + % + días + tope, solo coincidencias exactas) contra el texto de ayer: **56 de 57 coincidieron letra por letra** y la que faltaba (`brubank-ypf-lunes-10`, "App YPF" 10% lunes tope $6.000 en los tres planes) la confirmé a mano. Todas quedan con `verificado: 2026-09-20` y la fuente sumada. Nada cambió en Brubank respecto de lo que teníamos.

### Credicoop (texto de hoy): cosas nuevas que no se pueden cargar
La página del miércoles suma 12 tarjetas nuevas sin día propio ni tope ni provincia en el texto: **Supermercado Todo 30%, El Abastecedor 30%, La Gallega 30%, Alvear 30%, Arcoiris 30%, Kilbel 20% (+10% MODO), Hiper Libertad 10% (+10% MODO), Microgo 10%, Beer Market 10%, Usina Láctea El Puente 20%, Pinturería Giannoni 15% + 6 cuotas, Emar Phone 10%.** Son cadenas del interior (Santa Fe, Córdoba) y la regla dice que la zona se verifica, no se deduce: no cargué ninguna. También "Tienda Credicoop | Hasta 24 cuotas" (la tienda del banco, sin legal). Para Lucía: si la receta abre esas tarjetas, La Gallega/Alvear/Kilbel/Arcoiris darían promos de Santa Fe que hoy solo tenemos por Banco Santa Fe.

### El recolector
A las 07:32 ARG todo `crudo/` decía `leido: 2026-09-19` o `2026-09-20` y el cron no había arrancado (el de ayer a las 12:30 UTC se canceló a los 15 minutos, como todos los días desde el 18). Disparé una **parcial** con `ciudad vital yaguar ypf coto credicoop` a las 07:33: **terminó en 2 minutos, commit `af01249` ("Texto de las fuentes al 2026-09-21 07:34")**. No disparé el completo: tres días seguidos cancelado en la tanda brubank/ualá/macro/bpn, y Brubank ya estaba del 20/9. Por eso solo Coto y Credicoop están fechadas hoy; lo demás va al 19/9 o 20/9. Siguen viejas **ICBC (13/9, desde casa), Ciudad (10/9), Shell (9/9), McDonald's y Musimundo (27/8)**.

### Agenda: qué se trabajó
Pidió 7 (fravega, comafi, icbc, vital, yaguar, ypf, ciudad). Se miraron las 7; **ninguna aportó desde su propio texto** (lo de hoy salió de Coto y Credicoop, que pedí en la parcial para cruzar):
- **Frávega** ❌ 403 de CloudFront (885 bytes) y **Comafi** ❌ Cloudflare (3 KB), como todos los días desde Actions; la lectura buena sigue siendo la del 13/9 desde casa, ya trabajada entera el 14/9. Hoy usé la de Comafi del 13/9 (`git show 0c751d2:crudo/comafi.txt`) como fuente de la alta de MODO en Coto.
- **ICBC** ➖ sigue la lectura desde casa del 13/9 (280 promos), cruzada entera el 14/9. No la pedí en la parcial: la API viene vacía al runner desde el 8/9.
- **Vital** ❌ (nunca aportó): hoy idéntica a ayer y a la semana pasada: el texto son las sucursales y las pestañas "Lunes … Domingo" y "Medios de pago", **las promos las arma JavaScript o son imágenes**; 1,3 KB. No va a aportar así.
- **Yaguar** ❌ (nunca aportó): Cloudflare "Sorry, you have been blocked" (895 bytes), igual que siempre desde Actions.
- **YPF** ❌ (nunca aportó): `ypf.com/promociones` es el menú del sitio corporativo y termina en "Lo sentimos, esta página no está disponible en este momento". **La URL de la ficha está muerta**; las promos de YPF las tenemos por los bancos (Brubank, Cuenta DNI, MODO).
- **Ciudad** ❌ (la más abandonada, 13 días): **vacía por 11.º día** (`OJO: el 2026-09-21 no se pudo leer (vino vacía)`). Las 48 que quedan en baja se reviven con una lectura desde casa (`node tools/recolectar.js ciudad`).

### Para Lucía
1. **Banco Ciudad: 11 días sin leerse desde Actions.** Hoy revivió una (Coto lunes) porque Coto nombró al banco; las otras 48 esperan la lectura desde casa.
2. **PedidosYa Plus 35% de Macro quedó apagada por contradicción del propio banco** (portada: lun/mar/vie Plus; API: martes débito General). Si abrís la promo en macro.com.ar y me decís qué dice, se revive.
3. **Coto tiene 7 tarjetas con el banco en imagen** (10% lun-jue, 15% viernes crédito, 30% jueves Visa/MC, 30% y 25% y 20% lunes, 20% jueves Visa): con el `alt` de la imagen se cargan o confirman solas.
4. **Credicoop sumó 12 comercios del interior el miércoles** (La Gallega, Alvear, Kilbel, Arcoiris, Hiper Libertad…) que la receta trae solo como título: sin provincia ni tope no se cargan.
5. **Vital, Yaguar e YPF no van a aportar nunca así como están** (JavaScript/imágenes, Cloudflare, URL muerta). Con Axion, BNA, Farmacity, La Anónima y Maxiconsumo ya son ocho "nuevas" que la agenda rota al pedo.
6. Mañana cumplen 11 días 24 de Cuenta DNI, 7 de Personal Pay y 6 de Galicia: sus textos del 19/9 están en `crudo/`, conviene una parcial con `cuenta-dni personal-pay galicia uala` a primera hora.
...
### ⚠ Lo importante del día, para que lo mire un humano: Banco Ciudad desapareció de la app
`validar.js` arrancó con 98 promos de más de 10 días, **49 visibles: 45 de Banco Ciudad y 4 de Buepp**, todas verificadas por última vez el 8/9 con el catálogo leído por la API del banco. Desde el 11/9 esa API **devuelve vacío al runner de GitHub, 9 días seguidos** (`✗ banco ciudad 0 — vino vacía — se conservó la lectura anterior`, en todos los runs del 11/9 al de hoy); `crudo/ciudad.txt` sigue siendo la lectura del 10/9. Las crucé igual contra las páginas de los comercios de ayer (`cruzar.js --id` en Coto, Día, Disco, Jumbo, Vea, ChangoMás, Diarco, Makro): **ninguna nombra a Banco Ciudad ni a Buepp**, así que no hay nivel 2 que las sostenga. Como pasó el 14/9 con las 5 de Banco Santa Fe, apliqué la regla: **las 49 quedan con `confianza: "baja"` y un `baja_motivo` que dice que NO vencieron, solo que no se pudieron verificar**; `vigencia_hasta` sigue en 30/9 y todas las fuentes quedan. La app no las muestra desde hoy. Son, entre otras: Coto martes 20% sin tope y lunes 25%, Día vie/sáb 20%, Disco vie/sáb 20%, Jumbo mar/jue 20%, Vea viernes 20%, ChangoMás lunes 20%, Makro jueves 20%, Diarco Barrio sáb/dom 20%, Nini, farmacias (Farmacity online, Farmacias MODO, ABC, Paradiñeiro, FarmaPlus, jubilados lunes 30%), estaciones de servicio domingo 10%, cines sábado 50%, las 4 de Mastercard al 35% (MásGO, Farmacity/GTL/Simplicity, cafés, The Food Market), perfumerías, deportivas, calzado, librerías, las cuotas (Casa del Audio, Samsung, Rex, Pisano, On City, bicicleterías 24), y de Buepp los 221 Comercios Vecinos 30%, Ferias Itinerantes 30%, RES finde 30% y gastronómicos finde 20%.

**Cómo se arregla, y es rápido:** correr `node tools/recolectar.js ciudad` desde la PC de Lucía (como se hizo el 13/9 con ICBC, Comafi y Frávega) y subir `crudo/`. El script de hoy (`cruzar-ciudad.js`, guarda por comercio + día + % + tope) pasó 49 de 49 contra la lectura del 10/9, así que si el catálogo sigue igual mañana la rutina las revive todas en un paso; la regla del instructivo lo pide ("si una fuente de hoy nombra una promo que está en baja, revivila"). Si Lucía prefiere que sigan visibles mientras tanto, es dar vuelta el `confianza` de las 49 que tienen ese `baja_motivo`: no se tocó nada más.

**Por qué no las dejé:** el instructivo dice que más de 10 días sin verificar va a `baja`, y que un dato mal es peor que uno faltante. Ciudad es además la fuente donde la ausencia sí vale como evidencia (catálogo completo), y nueve días sin poder mirarlo es demasiado para sostener un 35% o un "sin tope" en la caja. Lo que no hice fue retirarlas: no hay ninguna fuente que diga que vencieron.

### El recolector, otra vez
A las 07:32 ARG todo `crudo/` decía `leido: 2026-09-18` y el cron no había arrancado (octavo día seguido). Disparé `workflow_dispatch` a las 07:33 (run 54) y **GitHub lo canceló a los 15 minutos, igual que ayer**: leyó bien las 32 primeras en 3 minutos y la tanda **brubank / ualá / macro / bpn se colgó 12 minutos** hasta el `timeout-minutes: 15`. Es el mismo punto exacto que ayer (run 51). A las 07:48 disparé una corrida parcial con `ciudad burger-king farmacity bna axion` (run 55): **terminó en 1 minuto y el commit `c4eae47` ("Texto de las fuentes al 2026-09-19 07:49") llegó a las 07:49**. Las 5 vinieron letra por letra iguales a ayer (solo cambió el `leido:`), Ciudad vacía otra vez. Por eso todo lo que se apoya en otras fuentes va fechado **18/9** (el `leido:` real), no 19. Siguen viejas **ICBC (13/9, desde casa), Ciudad (10/9), Shell (9/9), McDonald's y Musimundo (27/8)**; en el run cancelado de hoy además **Burger King vino corta (916 bytes)** y Farmarket larga (27 KB), pero como no commiteó no cambió nada; en la parcial Burger King volvió entera (39 KB).

### Agenda: qué se trabajó
Pidió 7 (fravega, comafi, icbc, axion, bna, farmacity, burger-king). Se miraron las 7; **ninguna aportó una promo**:
- **Frávega** ❌ 403 de CloudFront (885 bytes). **Comafi** ❌ Cloudflare "Verificación de seguridad" (3 KB). Las dos se leen solo desde casa, como dice su ficha.
- **ICBC** ➖ sigue la lectura desde casa del 13/9 (221 KB, 280 promos), ya cruzada entera el 14/9. La API vino vacía al runner otra vez. Nada que cambiar; lo único de "burger" ahí es Ringo Burgers Club (no es Burger King).
- **Axion** ❌ (nunca aportó): la misma página institucional de ayer: bases de "Descuento Super", Desafío Redondo, pelotas, Coca-Cola, Lollapalooza. Sin bancos.
- **BNA** ❌ (nunca aportó): mismos títulos sin medio ni tope. "Especial Aerolíneas 30% y 18 cuotas" vence mañana 20/9; "Shopping con BNA 16-17/9" ya pasó; el "COTO 20% los martes al 31/10" sigue sin poder cargarse sin tarjetas ni tope.
- **Farmacity** ❌ (nunca aportó): `/promociones-bancarias` no existe, la página dice "No encontramos resultados para promociones-bancarias" y muestra el buscador (821 bytes). **Para Lucía: la URL de la ficha está mal**; hay que buscar la página real de promos bancarias de Farmacity (o cargarla desde Ciudad/Brubank/ICBC, que sí la publican).
- **Burger King** ➖ (la más abandonada, 12 días): la página de bases y condiciones (39 KB, leída bien hoy) es **idéntica a la del 7/9**: sorteo de papas de la app, Clarín 365 15%/20%, Personal Pay "hasta 31/12/2025", Cencopay jue-dom sin %, **Brubank Plan One viernes 10% $2.000/mes y Plan Plus sáb-dom 20% $4.000/mes** (contradice a brubank.com, que dice One lun/vie 20% y Plus vie-sáb-dom 30%; gana el emisor, la nota quedó sumada de nuevo con fecha de hoy), Banco del Sol 20% débito tope $5.000 y Hipotecario 40% NFC Visa crédito tope $15.000 **sin fecha ni año** (no se cargan: la misma página tiene entradas de 2025), Mercado Pago miércoles 15% "hasta 31 diciembre 2025". Lo que sí hice: **las 3 de Brubank en Burger King (`brubank-burger-king-30`, `-plus-30`, `-one-20`) quedaron confirmadas con brubank.com leída ayer** (Ultra 30% todos los días tope $6.000; Plus 30% vie/sáb/dom; One 20% lun/vie), `verificado: 2026-09-18`.

### Para Lucía
1. **Banco Ciudad: 49 promos apagadas hoy.** Se revive todo con una lectura desde casa (`node tools/recolectar.js ciudad` + subir `crudo/`). Si la API del banco empezó a bloquear datacenters como ICBC, la receta necesita el mismo tratamiento o pasa a la lista de "se lee desde casa una vez por semana".
2. **El recolector completo ya no entra en 15 minutos, dos días seguidos, colgado en la misma tanda (brubank/ualá/macro/bpn).** Anoche del 17 sí terminó en 8. Sigue pendiente lo de ayer: subir `timeout-minutes` a 30 y ponerle tope por fuente a las recetas de API. Mientras tanto la rutina se salva con corridas parciales (`fuentes:` en el dispatch), que tardan 1 minuto.
3. **Farmacity: la URL de la ficha no existe.**
4. La agenda lleva una semana pidiendo Frávega, Comafi e ICBC, que no se leen desde Actions, y tres "nuevas" que son páginas muertas (Axion, BNA, Farmacity). Cuatro de los siete lugares de la agenda no pueden aportar nada desde acá.

## 2026-09-18 — GitHub canceló el recolector a los 15 minutos (ya no entra con las fuentes nuevas); una corrida parcial trajo el texto de hoy de las 6 fuentes que hacían falta. 5 altas de la fuente nueva BPN (Neuquén, cuotas por día del Club de Beneficios); las 8 visibles que hoy cumplían 11 días (4 de ChangoMás, 4 cuotas de Sodimac) siguen iguales; MODO por fin trajo títulos; la agenda pidió 7 y solo BPN aportó

**591 promos (eran 586): 5 altas, 0 revividas, 0 retiradas, 0 corregidas, 15 verificadas al 18/9 (las 8 de los 11 días, las 5 nuevas de BPN y 2 de MODO).** Push: OK, en dos commits ("Datos al 2026-09-18": el primero con el texto del 17/9 a las 07:52 ARG para no demorar la app, el segundo con el texto de hoy). Visibles hoy: 438 con vigencia al 18/9 (226 valen un jueves, 242 un viernes). Ninguna visible queda con más de 10 días sin verificar; las 32 que lista `validar` son todas invisibles (vencidas al 31/8 o en `baja`).

### OJO: todo lo de hoy está fechado 2026-09-17, no 18 — GitHub canceló el recolector a los 15 minutos
A las 07:32 ARG todo `crudo/` decía `leido: 2026-09-17` y el cron del recolector no había arrancado (séptimo día seguido). Disparé `workflow_dispatch` a las 07:33 (run 51) y **a los 15 minutos GitHub lo canceló**: el workflow tiene `timeout-minutes: 15` y el paso "Leer las fuentes" no terminó. El log dice dónde se trabó: leyó bien las 32 primeras (ChangoMás 114 KB, Día, Carrefour, Coto, Jumbo, Disco, Vea, Diarco, Easy, Sodimac, Rappi 184 KB, Cuenta DNI, Supervielle, Petersen, Credicoop, Galicia, Naranja X, MODO, Personal Pay…) en 2 minutos y medio, y **la tanda siguiente —brubank, uala, macro y bpn— se quedó colgada 12 minutos hasta la cancelación**. Macro por API (55 páginas) y BPN (POST paginado de 800 comercios) son las dos fuentes que se sumaron anoche; alguna de las dos hoy no contestó y no hay un tope por fuente que la corte. Anoche la corrida de prueba (run 50) sí había terminado en 8 minutos.

Seguí la regla: **cada fuente que sumé va con la fecha del `leido:` real (17/9)**, `verificado` también 17/9. Los `crudo/` de ayer estaban enteros (ChangoMás 123 KB, Sodimac 13 KB, BPN 36 KB con los 800 comercios). Después disparé una corrida parcial solo con `bpn changomas sodimac bna axion modo` (run 52): **terminó en 6 minutos y el commit `cc315ca` ("Texto de las fuentes al 2026-09-18 07:57") llegó a las 07:58 ARG**. BPN, ChangoMás, Sodimac, BNA y Axion vinieron **idénticas a ayer letra por letra** (solo cambió el `leido:`), así que volví a pasar el mismo cruce con guardas y las 13 promos quedaron con la fuente de hoy y `verificado: 2026-09-18`. Lo que sigue abajo vale igual para el texto de hoy. Siguen viejas **ICBC (13/9, lectura desde casa), Ciudad (10/9), Shell (9/9), McDonald's y Musimundo (27/8)**; hoy el runner también reportó Dr. Ahorro con DNS caído y Ciudad y Shell vacías (se conservó la lectura anterior).

### Lo importante del día: BPN, la primera fuente de Neuquén, entra con 5 promos de cuotas
Anoche Lucía sumó tres fuentes provinciales al recolector (Macro por API, BPN y Banco de La Pampa) y la agenda me puso BPN entre las que "nunca aportaron". El archivo de ayer trae el Club de Beneficios entero: **800 comercios, 59 combinaciones de promo + día**, agrupados. La ficha pide cargarlo como grupo por campaña y no comercio por comercio, y eso hice:
- **Altas `cuotas-bpn-club-lunes-6`, `-martes-6`, `-miercoles-6`, `-jueves-6` y `-viernes-6`** (medio nuevo `bpn`, "Banco Provincia del Neuquén", `zona: Neuquén`): las campañas por día del sitio (Lunes salud y belleza, Martes generales, Miércoles indumentaria/bicis/motos/autos, Jueves construcción y hogar, Viernes gastronomía y peluquería), cada una como **6 cuotas sin interés con tarjetas de crédito del BPN en los comercios adheridos**, `descuento_pct: 0` para que la app las mande a la sección de cuotas. Rubros: belleza, comercios adheridos, indumentaria, hogar, gastronomía. Los comercios de cada día pegan con la campaña (lunes ópticas y estéticas, miércoles bicicleterías y autopartes, jueves aberturas y corralones, viernes bares y estilistas).
- **Por qué 0% y no 5%**: la ficha decía "casi siempre 5% de reintegro + cuotas", pero el listado dice otra cosa: de los 354 comercios del miércoles con 6 cuotas, solo 74 tienen un % encima (5%, 10%, alguno 15%); el resto es cuotas pelado. Cargar 5% para "comercios adheridos" mentiría en 4 de cada 5 locales. El % extra quedó dicho en `requisitos` ("algunos locales suman un reintegro de 5% a 10%") y el conteo en la `nota` de la fuente.
- **Vigencia**: las campañas por día no tienen fecha de fin en el sitio, así que `vigencia_hasta: null` (como Clarín 365 en Diarco). BPN se lee todos los días, la agenda la va a volver a traer y la regla de los 10 días la baja sola si desaparece. `vigencia_desde` es el día de la lectura.
- **No cargadas de BPN**: "PROMO INVIERNO 1/7 al 30/9: 12 cuotas Confiable y 6 Visa/Mastercard" (no se distingue en el listado qué comercios son), "SEMANA ESPECIAL JUBILADOS 14 al 20/9" y "Super Días SEMANA DE LA PRIMAVERA 14 al 21/9" (12 cuotas Confiable + **10% de reintegro**): están en el filtro del sitio pero el archivo no dice en qué comercios, y además vencen este fin de semana. Si la receta algún día separa por campaña, esas dos valen la pena.

### Las 8 visibles que hoy cumplían 11 días: todas iguales
`validar.js` arrancó con 40 promos de más de 10 días, 8 visibles, ninguna en la agenda. Las crucé por script con guarda por promo (comercio + día + % + tope + vigencia letra por letra contra el texto; si falta algo no se toca): **las 8 pasaron**.
- **ChangoMás (123 KB, bien cargada)**: `masclub-changomas` (mié/jue 15% sin tope socios MásClub al 31/12), `credicoop-changomas-jueves-cabal` (jueves 30% Cabal QR tope $9.000/semana al 30/9), `yoy-changomas-jueves` (jueves 20% Mastercard YOY tope $10.000/semana al 31/12), `columbia-changomas-mar-sab-20` (martes y sábados 20% crédito Visa/MC Columbia tope $10.000 al 30/9).
- **Sodimac (13 KB, con los legales)**: `cuotas-bbva-sodimac-6`, `cuotas-banco_provincia-sodimac-12` (CABA, GBA y PBA), `cuotas-galicia-sodimac-3` y `cuotas-naranja_x-sodimac-6`, todas hasta 30/09/2026. Dato al margen: BBVA agregó **12 y 9 cuotas (desde $900.000 y $600.000) solo online del 14 al 18/9**; vence hoy, no la cargué. Santander en Sodimac sigue con legal al 31/08 (no la tenemos).

### Agenda: qué se trabajó
Pidió 7 (fravega, comafi, icbc, axion, bna, bpn, modo). Se miraron las 7; **solo BPN aportó**:
- **Frávega** ❌ 403 de CloudFront (885 bytes). **Comafi** ❌ Cloudflare (3 KB). **ICBC** ➖ sigue la lectura desde casa del 13/9, ya cruzada entera el 14/9. Nada que cambiar.
- **Axion** ❌ (nunca aportó): la página de promociones (2 KB) es institucional: "Bases y condiciones Descuento Super", Desafío Redondo, promo pelotas, Coca-Cola, Lollapalooza. Ningún banco ni billetera. Las 6 promos que tenemos en Axion (Brubank x3, Galicia, Ciudad, Comafi) vienen de los emisores; Axion no las publica. **Para Lucía: esta fuente no va a aportar nunca desde esa URL**; si hay una página de "beneficios bancarios" de Axion es otra.
- **BNA** ❌ (nunca aportó): el mismo listado de títulos sin medio ni tope: "COTO 20% los martes del 18/8 al 31/10", "YPF 20% al 30/9", Tucson 25%, KFC 20%, "Especial Aerolíneas 30% y 18 cuotas del 14 al 20/9", y dos vencidas al 31/8 (Supermercados, Shell). El Coto de los martes sigue sin poder cargarse: ni la página de Coto ni la de YPF nombran al Nación, y el título del BNA no dice tarjetas ni tope. La página de Día sí nombra "Modo, BNA" lun a vie al 30/9, que ya tenemos (`bna-dia-lun-vie`).
- **MODO** ➖ (la más abandonada, 14 días): a la mañana solo el menú (1,3 KB), pero **en la corrida parcial de las 07:57 vino con títulos (3,4 KB)**: Destacadas ("20% de reintegro en ChangoMás", "10% y 3 cuotas en Veterinarias y Pet Shops", "10% de reintegro en Farmacias", "20% de reintegro en Transporte", "Hasta 100% de reintegro en Transporte", "15% de reintegro en YPF", "20% en Supermercados Kilbel", "15% en Central Oeste"), Supermercados ("20% en La Anónima", "15% en Supermercado La Ilusión", "20% en Supercoop CABA", "10% en Supermercados Atomo", "25% y 20% en Cooperativa Obrera", "10% en Cordial"), tiendas online (Seven Sport 30%, Farmacias Vilela 20%, Topper 20%, Vacalin 20%, FarmaPlus 15%) y financiación ("9 cuotas sin interés en Frávega online", "12 cuotas en PSA", "9 cuotas en Indumentaria", Viaja+). Son títulos sin día, banco ni tope (la página muestra eso y hay que abrir cada una), así que **no cargué ninguna**; sumé el listado como nivel 3 a las dos que nombra tal cual: `modo-changomas-lunes` (20%) y `cuotas-modo-fravega-9`. Para los "20% en La Anónima", "15% en YPF" y "20% en Transporte" hace falta abrir la promo: sin el banco y el día no se puede cargar.

### Para Lucía
1. **URGENTE: el recolector ya no entra en los 15 minutos del workflow.** Hoy GitHub lo canceló en el paso "Leer las fuentes" con la tanda brubank/uala/macro/bpn colgada 12 minutos. Si mañana pasa lo mismo, la rutina se queda otra vez sin texto de hoy. Dos arreglos posibles, los dos en `.github/workflows/recolectar.yml` y `tools/recolectar.js` (no los toqué porque la rutina solo publica datos): subir `timeout-minutes` a 30 y ponerle un tope por fuente (por ejemplo 3 minutos) a las recetas de API, para que una fuente colgada no voltee a las 41. Además el cron sigue sin arrancar solo: séptimo día seguido lanzándolo a mano.
2. **Revisar las 5 de BPN** (`cuotas-bpn-club-*`): es la primera vez que la app muestra algo en Neuquén y el criterio "6 cuotas, 0%" es el mínimo común de un listado desparejo.
3. **Axion**: la URL de la ficha es institucional; no va a aportar.
4. **MODO hoy sí trajo el listado de títulos**: si la receta abriera cada promo (son unas 40) saldrían La Anónima 20%, YPF 15%, Transporte 20% y 100%, Cooperativa Obrera 25%, que hoy no tenemos por ningún lado.
5. **Macro por API ya está en `crudo/` (217 KB, 22 provincias)**, la ficha pide cargar ~40 por corrida empezando por Tucumán, Salta, Jujuy, Misiones, Córdoba. No estaba en la agenda de hoy; cuando la agenda la traiga, es un día entero.
...
### El workflow otra vez no disparó solo: lo lancé a mano
A las 07:33 ARG todo `crudo/` decía `leido: 2026-09-13`. Disparé `workflow_dispatch` a las 07:34 y el commit `d779c24` ("Texto de las fuentes al 2026-09-14 07:42") llegó a las 07:43 (9 minutos y medio). Siguen viejas **Ciudad (10/9), Shell (9/9)** y **McDonald's y Musimundo (27/8)**; con `ERROR` **Santander y Dr. Ahorro**; con 403 o vacías **La Anónima, Yaguar, Farmacity, MODO, Vital**. No toqué las promos de ninguna de esas. **El recolector volvió a pisar las lecturas desde casa de Comafi (queda Cloudflare, 3 KB) y Frávega (403, 885 bytes)**; ICBC no se pisó y sigue con `leido: 2026-09-13`. Es el problema conocido del 8/9: hasta que se arregle, `git show 0c751d2:crudo/comafi.txt` y `git show 0c751d2:crudo/fravega.txt`.

### Lo importante del día: la lectura desde casa del 13/9 (commit `0c751d2`)
Lucía corrió `leer-desde-casa` anoche y subió **ICBC (221 KB, 282 entradas por la API, 12 rubros), Comafi (200 KB, 104 entradas en los 5 rubros) y Frávega (22 KB, la página de legales entera)**. Es la primera lectura buena de las tres desde el 7/9, y la agenda las pedía "enteras". Como las 93 promos que tenemos de ICBC y Comafi (más las 13 con fuente Frávega) salieron de la lectura del 7/9 (`1ec9295`), lo que hice fue **comparar entrada por entrada la lectura del 13/9 contra la del 7/9** (por script, sobre las líneas `--- comercio | días | % | tarjetas | vigencia` y `por segmento`), y después cruzar cada promo nuestra contra el texto de anoche buscando el comercio, con guarda: si el comercio no aparece, la promo no se toca. Todo lo de estas tres fuentes va **fechado al 13/9**, que es el `leido:` real, no al 14.

- **Comafi (nivel 1): las 104 entradas son idénticas a las del 7/9**, letra por letra (mismos días, %, topes, medios y vigencias). Las 22 promos de Comafi que se apoyan en el sitio del banco quedaron confirmadas al 13/9 con la fuente sumada. Las dos de cuotas en Jumbo/Disco/Vea (`cuotas-comafi-jumbo-disco-vea-3` y `-electro-12`) no se tocan: salieron de los sitios de Cencosud y el sitio de Comafi no tiene rubro electro ni las lista. Verifiqué de paso el cruce de Coto martes: Comafi publica "10% adicional al 20% de la campaña MODO, totalizando 30%", así que `comafi-coto-martes-30` está bien.
- **Frávega (nivel 2): la página de legales es idéntica a la del 7/9** (los 16 bancos, todos "válida del 01 al 30 de septiembre de 2026"). Las 13 promos con fuente Frávega quedaron confirmadas al 13/9. Sigue la duda de Naranja X (Frávega dice 14 cuotas, Naranja X dice "hasta 12"): queda 12 porque el emisor manda. Siguen sin cargar BNA "hasta 20 cuotas" (remite a semananacion.com.ar, sin fechas), American Express y Banco Entre Ríos (no tenemos esos medios).
- **ICBC (nivel 1): 282 entradas contra 280 del 7/9, y solo 7 diferencias.** 62 promos confirmadas al 13/9 (todas las visibles de ICBC; las 5 restantes están en baja o vencidas desde agosto). Las diferencias:
  - **Paladini → Paladar.** El banco renombró la entrada (mismos términos: viernes, 20% tope $10.000 semanal, Exclusive 30% tope $20.000, hasta el 29/01/2027; la vigencia ahora dice desde el 12/08). Corregí `comercios` de `icbc-paladini-viernes-20` a "Paladar" y dejé el id. **Que lo mire Lucía:** no sé si "Paladini" era un error del banco o son dos comercios distintos.
  - **Bidcom y Gadnic pasaron de 6 a "hasta 9 cuotas"** (2, 3, 4, 5, 6 o 9 pagos) del 06/09/2026 al 31/01/2027. Alta `cuotas-icbc-bidcom-gadnic-9`; `cuotas-icbc-tecnologia-online-6` queda con Motorola y Phi-Digital (6 cuotas al 30/9).
  - **Perfumerías Pigmento, 18 al 20 de septiembre, 6 cuotas sin interés** con crédito Visa/Mastercard ICBC. Alta `cuotas-icbc-pigmento-18-20-sep-6` (el legal dice "válida en la República Argentina"; es solo financiación, sin porcentaje, así que va a la sección de cuotas).
  - **Prestigio salió de la Semana de la Pintura** (el 7/9 figuraba al 15/9); queda solo Rex hasta el 14/9 en `cuotas-icbc-semana-pintura-rex-prestigio-12`. Mañana vence sola.
  - **Farmacia Añón, nueva:** martes y viernes 20% + 3 cuotas, tope $20.000 por mes, del 11/09 al 27/11. **No la cargué** porque el banco no dice la provincia y la regla de la zona manda. Si Lucía sabe dónde está, se carga en un minuto.
  - Simmons / Simmons Casa solo cambiaron de orden.
  - Las puntuales que terminaron el 13/9 (Paruolo especial moda, Andrés Merino y Sodimac de la Semana de la Pintura) siguen listadas por el banco con esa fecha de fin; les puse `baja_motivo` para que no molesten en la cola.

### ⚠ Revividas (2): estaban en `baja` por error desde el 8/9 — que lo mire un humano
El 8/9 la corrida "revivió" `coto-icbc-jueves-20` (Coto, jueves, 20% con Visa Débito ICBC sin tope, hasta el 31/12, CABA/GBA y principales ciudades) y `coto-icbc-lunes-20` (Coto Digital, lunes, 20% tope $15.000 por compra, hasta el 31/12): les sumó la fuente del banco y el `verificado`, pero **las dejó con `confianza: "baja"`**, y `validar.js` no toca las que ya están apagadas ("ya está apagada, no molesta"). Resultado: seis días escondidas mientras el banco las publicaba. Lo vi porque el cruce de hoy las encontró en el texto de ICBC. La lectura del 13/9 las lista igual (COTO jueves DEBITO 20% del 01/07 al 31/12; COTO DIGITAL lunes GENERAL 20% tope $15.000 por transacción). Pasan a `alta` con la fuente de hoy. Conviven con `icbc-coto-jueves-debito-nfc-30` (30% por NFC, solo hasta el 24/9) e `icbc-coto-martes-20`. **Lección para las próximas corridas: revivir es también poner `confianza: "alta"`; el auditor no lo hace solo.**

### Las 7 visibles que hoy cumplían 11 días
- **Carrefour (nivel 2, 56 KB, bien cargado) confirma las 2 suyas**: `carrefour-banco-lun-mar-15` ("Todos los lunes y martes de Septiembre | 15% | crédito Carrefour Banco | en el acto y sin tope", legal exclusivo Carrefour Maxi hasta el 30/09) y `club-lanacion-carrefour-10` ("Martes a Domingo | 10% | Club LA NACION (Solo Entrega Inmediata) | Sin Tope", solo online con Entrega Inmediata, un uso por día). Fuente sumada, verificadas al 14/9.
- **Banco Santa Fe (Petersen): 5 a `baja` por viejas, y sigue siendo culpa de la receta.** `santa_fe-la-reina-lunes`, `santa_fe-dar-martes`, `santa_fe-kilbel-miercoles`, `santa_fe-alvear-lunes-jueves` y `santa_fe-supermercados-modo-viernes-20` cumplieron 11 días. La página 1 de 2 de hoy ("Resultados 1 - 12 de 24") es idéntica a la de ayer: ChangoMás, Día, La Anónima, Vea, Jumbo, Bacim, Alfa, Beltrán, La Gallega, Diarco, Makro y Disco; las cinco siguen en la página 2, que la receta de `petersen` no lee. Regla de los 10 días: `confianza: "baja"`, la app las esconde. **No las retiré** (igual que Kilbel viernes ayer): en cuanto la receta recorra la paginación, o Lucía corra `node tools/recolectar.js petersen` desde casa y suba `crudo/`, vuelven solas sumándoles la fuente. Con esto Banco Santa Fe queda con 6 promos escondidas que el banco casi seguro sigue publicando.

### Agenda: qué se trabajó
Pidió 7 (fravega, comafi, icbc, axion, bna, farmacity, hipotecario). Se miraron las 7:
- **Frávega, Comafi e ICBC** ✅ enteras, por primera vez con texto nuevo (ver arriba).
- **Axion** ❌ (nunca aportó): 2,1 KB idénticos a ayer; la página de promociones solo tiene las bases de "Descuento Super" de Pan American Energy (promo propia de la petrolera, no de un banco) y "Desafío Redondo". No hay banco, día ni %.
- **BNA** ❌ (nunca aportó), pero **deja pistas**: 2 KB idénticos a ayer, la portada de Descuentos y Promociones lista títulos con vigencia y sin día ni tope: "YPF 20% de descuento, del 1-3 al 30-9-2026", "DIA 20% de descuento, del 4-9 al 30-9-2026", "Tucson 25% de ahorro todos los días, 1-9 al 30-9", "KFC -20%, 1-6 al 30-9", "Jurassic World hasta 3 cuotas", y dos vencidas (Supermercados hasta 30% y Shell 20%, al 31-8). Nada de eso se puede cargar sin el detalle. **Ojo con Día:** la única promo BNA que Día publica en su sitio es la de jubilados ANSES (lunes a viernes, tope $5.000 semanal, que es `bna-dia-lun-vie`); el "20% del 4/9 al 30/9" que anuncia el BNA no está en Día. La receta debería abrir cada tarjeta ("haciendo clic en cada promoción" dice la página).
- **Farmacity** ❌ (nunca aportó): 821 bytes, "No encontramos resultados para promociones-bancarias". La URL de la receta está muerta.
- **Hipotecario** (la más abandonada): la portada de alianzas mostró otra vez Sueño Azul (jueves 25% débito tope $40.000, jueves 6 cuotas, 3 cuotas todos los días), sin provincia: no se carga. Sus dos de supermercados quedaron confirmadas ayer por ChangoMás y Jumbo.

### Para Lucía
1. **Paladini/Paladar en ICBC**: ¿qué comercio es? El banco lo renombró; dejé "Paladar".
2. **Farmacia Añón** (ICBC, martes y viernes 20% + 3 cuotas): falta la provincia para cargarla.
3. **Banco Santa Fe, página 2**: ya son 6 promos escondidas por la paginación (Kilbel viernes ayer, cinco hoy). Es la receta de `petersen`, no el banco.
4. Las dos revividas de Coto/ICBC: mirar en la app que no dupliquen a las de Coto con débito de otros bancos.
5. El recolector sigue pisando las lecturas desde casa de Comafi y Frávega; la de ICBC sí se respeta.
6. Naranja X en Frávega: ¿12 o 14 cuotas? Frávega insiste con 14.
