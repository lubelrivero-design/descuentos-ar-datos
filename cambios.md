...
## 2026-09-18 — El recolector no terminó a tiempo: se trabajó con el texto de ayer (fechado 17/9). 5 altas de la fuente nueva BPN (Neuquén, cuotas por día del Club de Beneficios); las 8 visibles que hoy cumplían 11 días (4 de ChangoMás, 4 cuotas de Sodimac) siguen iguales; la agenda pidió 7 y solo BPN aportó

**591 promos (eran 586): 5 altas, 0 revividas, 0 retiradas, 0 corregidas, 8 verificadas al 17/9.** Push: ver abajo. Visibles hoy: 438 con vigencia al 18/9 (226 valen un jueves, 242 un viernes). Ninguna visible queda con más de 10 días sin verificar; las 32 que lista `validar` son todas invisibles (vencidas al 31/8 o en `baja`).
...
- **MODO** ❌ (la más abandonada, 14 días): otra vez solo el menú (1,3 KB). Sus visibles siguen sostenidas por los comercios y los bancos; ninguna pasa los 10 días.
...
4. **Macro por API ya está en `crudo/` (217 KB, 22 provincias)**, la ficha pide cargar ~40 por corrida empezando por Tucumán, Salta, Jujuy, Misiones, Córdoba. No estaba en la agenda de hoy; cuando la agenda la traiga, es un día entero.
